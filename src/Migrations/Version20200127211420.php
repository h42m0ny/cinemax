 ...
 */
final class Version20200127211420 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE serie (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, note DOUBLE PRECISION DEFAULT NULL, summary LONGTEXT NOT NULL, image VARCHAR(255) DEFAULT NULL, first_air_date DATE DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
